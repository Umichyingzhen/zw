...
**数据分析师（STATCOM 项目)**  
_Monroe County Senior Services (门罗县老年服务中心)_ — 美国安娜堡（2025年9月 – 2025年11月）
- 分析 464 份调查问卷，重点关注交通出行状况和搬迁意向，以支持老年群体的出行规划；通过 Python 处理缺失值（12%–40%）、统一类别变量，并清除噪声，构建了一个干净的6变量数据集用于后续分析
- 通过构建百分比分布、缺失率诊断和分组比较，量化交通状况；结果显示 88% 的受访者表示出行没有困难，而没有私家车使用权的受访者出行遇到困难的可能性是他人的 3–5 倍，从而识别出交通脆弱群体
- 评估搬迁动机后发现，38% 的受访者表示只会因健康原因而搬迁，而45% 将“减少室外维护”视为最主要原因，揭示了影响“原地养老”决策的核心驱动因素，包括居住维护负担和环境可达性等问题（例如庭院维护、出行便利性）
- 构建了包含柱状图、100%堆叠交通对比图和搬迁原因排序图的可视化结果面板，使相关利益方能够将交通障碍与搬迁风险联系起来，并为出行能力受限的老年人制定优先干预策略提供依据
